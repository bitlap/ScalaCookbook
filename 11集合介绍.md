...
**Iterable** trait定义了一个*iterator*，它允许你循环中一次遍历集合中一个元素。但在使用迭代器时，只能遍历集合一次，因为每个元素在迭代过程中会被消耗。
...
关于基本**Set**类的详细内容，参考15.3小节“创建集合并添加元素”，关于可排序**Set**的详细内容，参考15.5小节“按排序顺序在Set中存储值”。
