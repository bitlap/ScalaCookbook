...
在我的例子中，没有尝试监视这些死信，只是让日志记录工具将它们打印到控制台。 如果要监视本地系统的死信，可以创建一个订阅**akka.actor.DeadLetter**类的actor。 这个过程在[Akka event bus]()页上进行了描述，订阅的过程类似于查找actor并监听它们，在我的博客文章“Akka Typed： Finding Actors with the Receptionist”中展示了这个例子。
