...
出于各种原因，包括从你的代码中删除**null**值，你想有效地使用**Option/Some/None**、**Try/Success/Failure**和**Either/Left/Right**类。

### 解决方案

该小节与24.5小节有一些重叠。该小节展示了在以下情况下，使用**Option**而不是**null**：
...
**math**表达式的使用方式就像在**Option**和**Try**一样：
