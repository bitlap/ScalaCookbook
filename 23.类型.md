...
综上所述，产生这种冲突的一个主要原因是 **ArrayBuffer** 元素可以被修改。如果你想写一个方法来使所有的 **Dog** 类型和它的子类型可以speak，可以通过指定类型为 **+A** 来定义它接受不可变的元素集合，比如 **List**、**Seq** 和 **Vector** 这些类就是这么做的。关于这种方法的细节，请参阅23.3小节。
