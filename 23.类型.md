...
&nbsp;&nbsp;&nbsp;&nbsp; 当我使用这些注释之一定义一个新的 **Container** 类型时，如果我还定义了一个 **Dog** 类，它是 **Animal** 的一个子类型，那么 **Container[Dog]** 是 **Container[Animal]** 的一个子类型吗？
...
- 可以在Scala Style Guide的命名约定页面上找到有关Scala泛型类型命名约定的更多信息（ *https://oreil.ly/lAmou* ）。
