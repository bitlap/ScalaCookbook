...
表示“此特质中的函数只能作用于此类型。” 在大型的应用程序中，这种技术可以帮助其他开发人员更容易地理解特性的用途。这也是静态类型语言的优势之一。
...
为了开始展示**unapply**是如何工作的，这里有一个Person类，它有一个对应的伴生对象，该对象有一个**unapply**方法，该方法返回一个字符串：
...
* 如果想知道**unapply**的命名，可能是因为在伴生对象中，这个“解构”过程基本上与编写**apply**方法相反。关于伴生对象中的**apply**方法被用做构建新实例的工厂方法，可以参阅5.15小节。
